""" 
VQ-VAE module for HumanML3D dataset. From MotionGPT: https://github.com/OpenMotionLab/MotionGPT
Default parameters:
    quantizer: 'ema_reset'
    code_num: 512
    code_dim: 512
...
class VQVae(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.encoder = Encoder(nfeats, output_emb_width, down_t, stride_t, width, depth, dilation_growth_rate, activation=activation, norm=norm)

        self.decoder = Decoder(nfeats, output_emb_width, down_t, stride_t, width, depth, dilation_growth_rate, activation=activation, norm=norm)
